...
public class Mamiferos implements Parcelable {
    ...
    public Mamiferos(String continenteM,String nombreM, int idFotoAnimal, int idFotoContinenteM , String claseM, String pesoAdultoM, String longitudAdultoM, String promedioVidaM, String alimentacionM, String peligrosoM, String dondeViveM) {
